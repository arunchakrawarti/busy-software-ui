...
import {
    materialIssueData,
    defaultMaterialIssue,
} from "@/config/MaterialIssueDummyData";

const MainMaterialIssueInventory = () => {

    const [rows, setRows] = useState(materialIssueData);
    ...
    return (
        ...
        <div className="space-y-6">
            ...
            >
                <Modal
                    initialData={editing || defaultMaterialIssue}
                    onClose={() => setOpen(false)}
                    onSave={handleSave}
                />
            </OverlayModal>
...
export default MainMaterialIssueInventory;